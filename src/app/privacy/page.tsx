...
export const metadata: Metadata = {
    title: "Privacy Policy - Stage Ready",
            ...
            <div className="space-y-8">
                <div className="space-y-4">
                    ...
                    <p className="text-muted-foreground">
                        <strong>Stage Ready</strong> is committed to providing quality services to you and this policy outlines our
                ...
                <div className="space-y-4">
                    ...
                    <p>
                        ...
                        Information Commissioner at <a href="https://www.oaic.gov.au/" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">https://www.oaic.gov.au/</a>.
                    </p>
                </div>

                <div className="space-y-4">
                    <h2 className="text-2xl font-semibold tracking-tight">What is Personal Information and why do we collect it?</h2>
                    <p>
                        Personal Information is information or an opinion that identifies an individual. Examples of Personal
                        Information we collect includes names, addresses, email addresses, phone numbers.
                    </p>
                    <p>
                        This Personal Information is obtained in many ways including interviews, correspondence, by telephone, by
                        email, via our website www.stageready.com.au, from media and publications, from other publicly available
                        sources, from cookies and from third parties. We don’t guarantee website links or policy of authorised third
                        parties.
                    </p>
                    <p>
                ...
                <div className="space-y-4">
                    <h2 className="text-2xl font-semibold tracking-tight">Sensitive Information</h2>
                    <p>
                ...
                <div className="space-y-4">
                    <h2 className="text-2xl font-semibold tracking-tight">Disclosure of Personal Information</h2>
                ...
                <div className="space-y-4">
                    <h2 className="text-2xl font-semibold tracking-tight">Security of Personal Information</h2>
                    <p>
                ...
                <div className="space-y-4">
                    <h2 className="text-2xl font-semibold tracking-tight">Access to your Personal Information</h2>
                    <p>
                    ...
                    <p>
                        <strong>Stage Ready</strong> will not charge any fee for your access request, but may charge an
                ...
                <div className="space-y-4">
                    <h2 className="text-2xl font-semibold tracking-tight">Maintaining the Quality of your Personal Information</h2>
                    <p>
                ...
                <div className="space-y-4">
                    <h2 className="text-2xl font-semibold tracking-tight">Privacy Policy Complaints and Enquiries</h2>
                    <p>If you have any queries or complaints about our Privacy Policy please contact us at:</p>
                    <div className="mt-4 p-4 bg-secondary/50 rounded-lg">
                        <p className="font-medium">Stage Ready</p>
                        <p>Melbourne, Victoria</p>
                        <p>
                            <a href="mailto:info@stageready.com.au" className="text-primary hover:underline">
